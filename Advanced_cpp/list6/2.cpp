...
int main() {
    list<point> points = {
        point(  1.0,  2.0, {255,   0,   0}, "pkt1"),
        point( -2.0,  3.0, {  0, 255,   0}, "pkt2"),
        point( -1.0, -1.0, {  0,   0, 255}, "pkt3"),
        point(  3.0, -4.0, {128, 128, 128}, "pkt4"), 
        point(  0.5,  0.5, { 30,  20,  10}, "pkt5"),
        point( -3.0,  1.0, { 60,  60,  60}, "pkt6"),
        point(  2.0, -5.0, { 10,  10,  10}, "pkt7"),
        point(  4.0,  1.0, {200, 200, 200}, "pkt8"),
        point( -4.0,  2.0, {100,  50,  50}, "pkt9"),
        point( -2.5, -3.5, { 50, 100, 150}, "pkt10"),
        point(  1.5, -2.5, { 20,  20,  80}, "pkt11"),
        point(  0.2,  3.5, {220,  10,  10}, "pkt12"),
        point(  5.0,  5.0, {255, 100, 100}, "pkt13"),
        point( -5.0,  5.0, {  0, 255,   0}, "pkt14"),
        point( -5.0, -5.0, {  0,   0, 255}, "pkt15"),
        point(  5.0, -5.0, {250, 250, 250}, "pkt16"),
        point( -1.0,  4.0, { 40,  40,  40}, "pkt17"),
        point(  2.0,  0.0, { 90,  90,  90}, "pkt18"),
        point(  0.0, -3.0, { 30,  70,  30}, "pkt19"),
        point(  1.2,  1.8, { 15,  15,  15}, "pkt20"),
        point( -2.2,  2.8, { 70,  70,  90}, "pkt21aaa"),
        point( -1.5, -2.2, {  5,   5,   5}, "pkt22aaa"),
        point(  3.3, -1.1, {240, 240,   0}, "pkt23aaa")
    };
